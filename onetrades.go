...
func NewHyperliquidFuturesClient(privateKeyHex string, isTestnet bool) (*hyperliquid.FuturesClient, error) {
	return hyperliquid.NewFuturesClient(privateKeyHex, isTestnet)
}
