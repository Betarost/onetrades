...
func TestOnetrades(t *testing.T) {
	...
	// printAnswers(okxFutures.NewGetInstrumentsInfo().Symbol("SOL-USDT-SWAP").Do(ctx))
	...
	// printAnswers(okxFutures.NewSetPositionMode().Mode(entity.PositionModeTypeOneWay).Do(ctx))
