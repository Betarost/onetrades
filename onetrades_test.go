...
func TestOnetrades(t *testing.T) {
	...
	// printAnswers(bybitFutures.NewGetPositionMode().Do(ctx))
	...
	printAnswers(bybitFutures.NewSetPositionMode().Symbol("SKYUSDT").Mode(entity.PositionModeTypeHedge).Do(ctx))
